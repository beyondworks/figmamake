        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-20 mx-[10px] my-[0px]">
          ...
          >
            <h2 className="sm:mb-6 font-[Pretendard] sm:text-[30px] md:text-[36px] font-bold mt-[0px] mr-[0px] mb-[16px] ml-[10px] text-[24px]">
              <span className="text-[#00E5AC] font-bold">프로젝트</span>를
              <br />
              시작할 준비가 되셨나요?
            </h2>
            ...
            <div className="space-y-5 sm:space-y-6 mx-[10px] my-[0px] m-[0px]">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="text-white mb-1 font-[Pretendard] text-sm sm:text-base">
                    Email
                  </h4>
                  <a
                    href="mailto:beyondworks.br@gmail.com"
                    className="text-white/60 hover:text-[#00E5AC] transition-colors font-[Pretendard] text-xs sm:text-sm break-all"
                  >
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:+821077996255"
                    className="text-white/60 hover:text-[#00E5AC] transition-colors font-[Pretendard] text-xs sm:text-sm"
                  >
                    +82 10-7799-6255
                  </a>
                </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/60 font-[Pretendard] text-xs sm:text-sm">
                    서울특별시 강남구 테헤란로
                  </p>
                </div>
              </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-white mb-[8px] font-[Pretendard] text-sm sm:text-base mt-[0px] mr-[0px] ml-[10px]"
                >
                  이름 *
                </label>
                <input
